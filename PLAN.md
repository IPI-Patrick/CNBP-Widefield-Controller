...
Tasks (from TODO.md, in priority order):
- [ ] Task 1 — Ignore up to 5 sequential AT_ERR_TIMEDOUT errors during preview/acquisition. On the 6th consecutive timeout print "Timed out more than 5 times" and safely stop the preview.

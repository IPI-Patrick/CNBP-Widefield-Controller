...
class Andor:
    ...
    def __init__(self):
        ...
        # self.dll    = WinDLL("C:\\Program Files\\Andor SOLIS\\atmcd64d")
        ...
        #         self.dll = ctypes.WinDLL("C:\\Program Files\\Andor SOLIS\\atmcd32d")
        #     else:
        #         self.dll = cdll("C:\\Program Files\\Andor SOLIS\\atmcd64d")
        # # for Linux
    ...
    def logFunction(self, err, fun=''):        
        print("[%s]: %s" %(fun, err))

    def verbose(self, error, function=''):
        if self.verbosity == True: 
            self.logFunction(error, function)

    def SetVerbose(self, state=True):
        self.logFunction = state
    ...
    def SaveAsBmpNormalised(self, path):
        ...
        if(maxIntensity == 0): maxIntensity = 0.0001

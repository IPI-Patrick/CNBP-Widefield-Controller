from .andor_sdk3_exceptions import ATCoreException, ErrorCodes
...
class ATCore(object):
    ...
    def is_implemented(self, AT_H, command):
        ...
        self.handle_return(self.lib.AT_IsImplemented(AT_H, command, result))
        return result[0]
    ...
    def is_readable(self, AT_H, command):
        ...
        """
        result = self.ffi.new("AT_BOOL *")
        self.handle_return(self.lib.AT_IsReadable(AT_H, command, result))
        return result[0]
    ...
    def is_writable(self, AT_H, command):
        ...
        """
        result = self.ffi.new("AT_BOOL *")
        self.handle_return(self.lib.AT_IsWritable(AT_H, command, result))
        return result[0]
    ...
    def is_readonly(self, AT_H, command):
        ...
        """
        result = self.ffi.new("AT_BOOL *")
        self.handle_return(self.lib.AT_IsReadOnly(AT_H, command, result))
        return result[0]
    ...
    def set_int(self, AT_H, command, value):
        ...
        self.handle_return(self.lib.AT_SetInt(AT_H, command, value))

    def get_int(self, AT_H, command):
        """Run command and get Int return value.
        """
        result = self.ffi.new("AT_64 *")
        self.handle_return(self.lib.AT_GetInt(AT_H, command, result))
        return result[0]
    ...
    def get_int_max(self, AT_H, command):
        ...
        """
        result = self.ffi.new("AT_64 *")
        self.handle_return(self.lib.AT_GetIntMax(AT_H, command, result))
        return result[0]
    ...
    def get_int_min(self, AT_H, command):
        ...
        """
        result = self.ffi.new("AT_64 *")
        self.handle_return(self.lib.AT_GetIntMin(AT_H, command, result))
        return result[0]
    ...
    def set_float(self, AT_H, command, value):
        ...
        """
        self.__feature_updated(command)
        self.handle_return(self.lib.AT_SetFloat(AT_H, command, value))

    def get_float(self, AT_H, command):
        """Run command and get float return value.
        """
        result = self.ffi.new("double *")
        self.handle_return(self.lib.AT_GetFloat(AT_H, command, result))
        return result[0]
    ...
    def get_float_max(self, AT_H, command):
        ...
        """
        result = self.ffi.new("double *")
        self.handle_return(self.lib.AT_GetFloatMax(AT_H, command, result))
        return result[0]
    ...
    def get_float_min(self, AT_H, command):
        ...
        """
        result = self.ffi.new("double *")
        self.handle_return(self.lib.AT_GetFloatMin(AT_H, command, result))
        return result[0]
    ...
    def get_bool(self, AT_H, command):
        ...
        """
        result = self.ffi.new("AT_BOOL *")
        self.handle_return(self.lib.AT_GetBool(AT_H, command, result))
        return result[0]
    ...
    def set_bool(self, AT_H, command, value):
        ...
        """
        self.__feature_updated(command)
        self.handle_return(self.lib.AT_SetBool(AT_H, command, value))

    def set_enumerated(self, AT_H, command, value):
        """Set command with Enumerated value parameter.
        """
        self.__feature_updated(command)
        self.handle_return(self.lib.AT_SetEnumerated(AT_H, command, value))
    ...
    def set_enumerated_string(self, AT_H, command, item):
        ...
        self.__feature_updated(command)
        self.handle_return(
            self.lib.AT_SetEnumString(AT_H, command, item))

    def get_enumerated(self, AT_H, command):
        """Run command and set Enumerated return value.
        """
        result = self.ffi.new("int *")
        self.handle_return(self.lib.AT_GetEnumIndex(AT_H, command, result))
        return result[0]
    ...
    def get_enumerated_string_options(self, AT_H, command):
        ...
        for i in range(0, count):
            ret = self.get_enumerated_string_by_index(AT_H, command, i)
            strings.append(ret)
        return strings
    ...
    def get_enumerated_string(self, AT_H, command, result_length=128):
        ...
        return self.get_enumerated_string_by_index(AT_H, command, ret)

    def get_enumerated_count(self, AT_H, command):
        """Run command and set Enumerated return value.
        """
        result = self.ffi.new("int *")
        self.handle_return(self.lib.AT_GetEnumCount(AT_H, command, result))
        return result[0]
    ...
    def is_enumerated_index_available(self, AT_H, command, index):
        ...
        """
        result = self.ffi.new("AT_BOOL *")
        ret = self.lib.AT_IsEnumIndexAvailable(AT_H, command, index, result)
    ...
    def get_enumerated_index_by_string(self, AT_H, command, item):
        ...
        count = self.get_enumerated_count(AT_H, command)
        for i in range(0, count):
            if self.get_enumerated_string_by_index(AT_H, command, i) == item:
                return i
        return -1
    ...
    def is_enumerated_index_implemented(self, AT_H, command, index):
        ...
        """
        result = self.ffi.new("AT_BOOL *")
        ret = self.lib.AT_IsEnumIndexImplemented(AT_H, command, index, result)
        self.handle_return(ret)
        return result[0]

    def get_enumerated_string_by_index(self, AT_H, command, index,
                                       result_length=128):
        ...
        self.handle_return(
            self.lib.AT_GetEnumStringByIndex(
                AT_H, command, index, result, result_length))
        return self.ffi.string(result)

    def command(self, AT_H, command):
        """Run command.
        """
        self.handle_return(self.lib.AT_Command(AT_H, command))

    def set_string(self, AT_H, command, strvalue):
        """SetString function.
        """
        self.__feature_updated(command)
        self.handle_return(self.lib.AT_SetString(AT_H, command, strvalue))
    ...
    def get_string(self, AT_H, command, result_length=0):
        ...
        result = self.ffi.new("AT_WC [%s]" % result_length)
        ret = self.lib.AT_GetString(AT_H, command, result, result_length)
        self.handle_return(ret)
    ...
    def get_string_max_length(self, AT_H, command):
        ...
        """
        result = self.ffi.new("int *")
        ret = self.lib.AT_GetStringMaxLength(AT_H, command, result)
        self.handle_return(ret)
        return result[0]
    ...
    def queue_buffer(self, AT_H, buf_ptr, buffer_size):
        """Put buffer in queue.
        """
        ret = self.lib.AT_QueueBuffer(AT_H, self.ffi.cast("AT_U8 *", buf_ptr),
                                      buffer_size)
        self.handle_return(ret)
    ...
    def wait_buffer(self, AT_H, timeout=20000):
        ...
        ret = self.lib.AT_WaitBuffer(AT_H, buf_ptr, buffer_size, int(timeout))
        self.handle_return(ret)
    ...
    def register_feature_callback(self, AT_H, feature, func):
        ...
        """
        ret = self.lib.AT_RegisterFeatureCallback(AT_H, feature, func,
                                                  self.ffi.NULL)
        self.handle_return(ret)
    ...
    def unregister_feature_callback(self, AT_H, feature, func):
        """RegisterFeatureCallback function.
        """
        ret = self.lib.AT_UnregisterFeatureCallback(AT_H, feature, func,
                                                    self.ffi.NULL)
        self.handle_return(ret)
